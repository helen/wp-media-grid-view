...
(function($, _){
	...
	media.view.MediaFrame = media.view.Frame.extend({
		...
		initialize: function() {
			...
			if ( this.options.modal ) {
				...
				this.modal = new media.view.TopLevelMediaContainer({
					controller: this,
					title:      this.options.title,
					container:  this.options.container || document.body
				});
	...
	/**
	 * wp.media.view.TopLevelMediaContainer
	 *
	 * @constructor
	 * @augments wp.media.View
	 * @augments wp.Backbone.View
	 * @augments Backbone.View
	 */
	media.view.TopLevelMediaContainer = media.View.extend({
		tagName:  'div',
	 ...
	 * @augments Backbone.View
	 */
	media.view.Modal = media.view.TopLevelMediaContainer.extend({
		events: {
